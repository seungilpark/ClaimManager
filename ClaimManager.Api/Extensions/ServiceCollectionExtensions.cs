using ClaimManager.Api.Services;
using ClaimManager.Application.DTOs.Settings;
...
using ClaimManager.Infrastructure.Identity.Services;
using ClaimManager.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\ClaimManager.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
