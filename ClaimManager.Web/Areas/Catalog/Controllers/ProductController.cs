using ClaimManager.Application.Constants;
...
using ClaimManager.Application.Features.Products.Commands.Delete;
...
using ClaimManager.Web.Abstractions;
using ClaimManager.Web.Areas.Catalog.Models;
using ClaimManager.Web.Extensions;
...
namespace ClaimManager.Web.Areas.Catalog.Controllers
{
    [Area("Catalog")]
