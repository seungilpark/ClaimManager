        ...
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            var claims = new Claim[]
            {
                new Claim {  
                   ...
                   {
                        new ClaimItem { CurrencyId=currencies[2].Id, CategoryId=categories[1].Id, Amount=10.99M, Date=new DateTime(2021,01,03),  Description="This is a test item", Image="https://static.nike.com/a/images/w_1536,c_limit/9de44154-c8c3-4f77-b47e-d992b7b96379/image.jpg", Payee= "MazcoMac" },
                        new ClaimItem { CurrencyId=currencies[2].Id, CategoryId=categories[2].Id, Amount=110.99M, Date=new DateTime(2021,01,04), Description="This is another test item",Image="https://media.glamour.com/photos/5d4d8173a8093800088d56f8/16:9/w_3440,h_1935,c_limit/Jackets%20Everyone%20Should%20Own%20River.jpg",  Payee="Jason Huang", },
                ...
                new Claim {  
                    ClaimItems= new List<ClaimItem>
                    {
                        ...
                        new ClaimItem { CurrencyId=currencies[2].Id, CategoryId=categories[2].Id, Amount=50.99M, Date=new DateTime(2021,01,05),  Description="This is another test item",  Image="https://c.files.bbci.co.uk/EB24/production/_112669106_66030514-b1c2-4533-9230-272b8368e25f.jpg", Payee="Jason Huang",},
